...
import com.pdx.entity.UserRole;
...
import com.pdx.modal.common.CurrentUser;
import com.pdx.modal.dto.UserDto;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Override
    public String currentRoles(String userId) {
        UserRole userRoles = userRoleMapper.selectOne(new QueryWrapper<UserRole>().eq("user_id", userId));
        if (userRoles == null) {
            return "";
        }
        Role roles = roleMapper.selectById(userRoles.getRoleId());
